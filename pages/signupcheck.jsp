...
<%
	...
	//查詢使用者名稱是否存在
	 ...
	 //如果不存在,把資料插入到表格中
		 ...
		 PreparedStatement tmt =con.prepareStatement("INSERT into `members`(customer_id,sex,birthday,tel,pwd,checkpwd,email) VALUES ('"+account+"','"+sex+"','"+birthday+"','"+tel+"','"+password+"','"+checkpassword+"','"+email+"')");//向資料庫存入資料
		 //out.print(sql);
		 //out.close();
