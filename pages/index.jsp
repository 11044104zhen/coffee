    ...
    <header>
		...
		<div>
            <form action="search.jsp" method="get">
				<span class="icon"><img src="../image/search.png" style="width:3% ; height:5% ; position:absolute;top:4.2%;left:64%"></span>
				<input type="search"  id="search" placeholder="Search..." name="search" style="position:absolute;top:5.2%;left:67%;height:3%"/>
			</form>
        </div>
        <nav>
